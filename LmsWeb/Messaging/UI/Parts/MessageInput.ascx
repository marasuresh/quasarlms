...
<n2:Box ID="commentInput" runat="server" CssClass="box" meta:resourcekey="BoxResource1">
    <table style="table-layout: fixed" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td width="20%">
                <asp:Label runat="server" AssociatedControlID="selUser" CssClass="label" meta:resourcekey="lblToResource1" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label runat="server" AssociatedControlID="txtSubject" CssClass="label" meta:resourcekey="lblSubjectResource1" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label runat="server" AssociatedControlID="btnFileUpload" CssClass="label" meta:resourcekey="lblUploadResource1" />
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label runat="server" AssociatedControlID="rblMessageType" CssClass="label" meta:resourcekey="rblMessageType"
                    Text="Тип" />
            </td>
            <td>
                <asp:RadioButtonList runat="server" ID="rblMessageType" RepeatDirection="Horizontal">
        ...
        <tr>
            ...
            <td align="right">
                <asp:Button ID="btnToDr" runat="server" OnClick="btnToDr_Click" Text="ToDr" meta:resourcekey="btnToDrResource1" />
                <asp:HyperLink ID="hlCancel" Text="Cancel" meta:resourcekey="btnCancelResource1"
                    runat="server" />
            </td>
        </tr>
        </tbody>
