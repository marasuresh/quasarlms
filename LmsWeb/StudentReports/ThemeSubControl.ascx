<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ThemeSubControl.ascx.cs" Inherits="StudentReports_ThemeSubControl" %>
...
<tr><td nowrap=true>
    ...
    <asp:Label ID="themeNameLabel" runat="server"/>
</td><!-- калькуляции -->
