<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportTableControl.ascx.cs" Inherits="StudentReports_ReportTableControl" %>
<%@ Register Src="ReportFilterControl.ascx" TagName="ReportFilterControl" TagPrefix="uc1" %>
<%@ Reference Control="~/StudentReports/CourseDomainSubControl.ascx" %>
...
<tr>
    ...
    <asp:PlaceHolder ID="topLevelDomainsPlaceHolder" runat="server"/>
</table>
