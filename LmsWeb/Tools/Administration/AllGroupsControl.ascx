<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AllGroupsControl.ascx.cs" Inherits="Administration_AllGroupsControl" %>
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
    ...
    <Columns>
        ...
        <asp:ButtonField CommandName="ExecuteCommand" DataTextField="Name" HeaderText="Група" SortExpression="Name" />
    </Columns>
...
<asp:SqlDataSource ID="UserGroupsDataSource" runat="server" CancelSelectOnNullParameter="False"
    ...
    SelectCommand="dcetools_Access_Users_GetAllGroups" SelectCommandType="StoredProcedure">
</asp:SqlDataSource>
