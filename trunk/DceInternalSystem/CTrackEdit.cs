...
{
	/// <summary>
	/// Редактирование трека курсов
	/// </summary>
	public class CTrackEdit : System.Windows.Forms.UserControl
	{
		/// <summary> 
      ...
      protected CTrackEditControl Node;
		public CTrackEdit(CTrackEditControl node)
		{
   ...
   public class CTrackEditControl : RecordEditNode
   {
      public CTrackEditControl(NodeControl parent , string id)
         : base(parent, "select * from CTracks" , "CTracks", "id", id)
      {
         this.CaptionChanged();
         this.Expand();
      }
      ...
      public override System.Windows.Forms.UserControl GetControl()
      {
         ...
         {
            this.fControl = new CTrackEdit(this);
         }
      ...
      public override void CreateChilds()
      {
         if (!this.IsNew)
         {
            ...
            {
               new GroupEditNode(this,this.EditRow["Courses"].ToString(),
                  EntityType.course,true,"Курсы","",false,false);
            }
         }
      }
      ...
      protected override void InitNewRecord()
      {
         ...
         this.EditRow["Courses"] = System.Guid.NewGuid();
