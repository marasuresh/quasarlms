...
namespace DotNetSCORM.LearningAPI.Schema {
    using System;
    ...
    public abstract class AttemptItem {
        ...
        /// of the
        /// <a href="DnsConcepts.htm#Assignments">learner assignment</a>
    ...
    public abstract class PackageItem {
        ...
        /// <summary>
        /// Name of the IsActive property on the <Typ>PackageItem</Typ> item type.
        /// </summary>
        /// <remarks>
        /// Property type: Boolean<p/>
        /// Property can not contain null.<p/>
    ...
    /// <para>
    /// Each item of this <a href="DnsSchema.htm">LearningStore item type</a> contains
    /// information about one <a href="DnsConcepts.htm#Assignments">assignment</a>,
    /// i.e. one <a href="DnsConcepts.htm#Packages">organization</a> of one e-learning
    /// package, or one <a href="DnsConcepts.htm#Packages">non-e-learning document</a>,
    /// assigned to one or more learners, with zero or more instructors.
    /// </para>
    /// <para>
    /// This item type is available only in <a href="Default.htm">DotNetSCORM</a> (not in
    /// <a href="Mlc.htm">MLC</a>).
    /// </para>
    /// </summary>
    /// <remarks>
    ...
    /// <a href="DnsConcepts.htm#Packages">e-learning package</a> (not a non-e-learning
    ...
    /// <para>
    /// <b>
    /// <a href="DnsSchema.htm">Default operation-level security</a>:
    /// </b>
    ...
    public abstract class AssignmentItem {
        ...
        /// of the assigned SCORM <a href="DnsConcepts.htm#Packages">organization</a>.
        ...
        /// of the assigned <a href="DnsConcepts.htm#Packages">non-e-learning</a> document.
    ...
    /// <a href="DnsConcepts.htm#Assignments">instructor assignment</a>,
    /// i.e. the mapping of one instructor to one
    /// <a href="DnsConcepts.htm#Assignments">assignment</a>.
    ...
    /// <para>
    /// Each item of this <a href="DnsSchema.htm">LearningStore item type</a> contains
    /// information about one <a href="DnsConcepts.htm#Assignments">learner assignment</a>,
    /// i.e. the mapping of one learner to one
    /// <a href="DnsConcepts.htm#Assignments">assignment</a>.  For example, if an
    ...
    public abstract class LearnerAssignmentItem {
        ...
        /// <a href="DnsApi.htm#LearnerAssignmentStates">learner assignment state</a> is
        ...
        /// of the
        /// <a href="DnsConcepts.htm#Assignments">learner assignment</a>, if a
        /// <a href="DnsConcepts.htm#Packages">non-e-learning document</a> was assigned
...
namespace DotNetSCORM.LearningAPI {
    ...
    /// <summary>
    /// Represents an identifier to a <Typ>/DotNetSCORM.LearningAPI.Schema.AssignmentItem</Typ> in a store.
    /// </summary>
    public class AssignmentItemIdentifier : LearningStoreItemIdentifier {
        ...
        public AssignmentItemIdentifier(long key) : 
                base(DotNetSCORM.LearningAPI.Schema.AssignmentItem.ItemTypeName, key) {
        }
        ...
        public AssignmentItemIdentifier(LearningStoreItemIdentifier id) : 
            ...
            if ((id.ItemTypeName != DotNetSCORM.LearningAPI.Schema.AssignmentItem.ItemTypeName)) {
    ...
    /// <summary>
    /// Represents an identifier to a <Typ>/DotNetSCORM.LearningAPI.Schema.InstructorAssignmentItem</Typ> in a store.
    /// </summary>
    public class InstructorAssignmentItemIdentifier : LearningStoreItemIdentifier {
        ...
        public InstructorAssignmentItemIdentifier(long key) : 
                base(DotNetSCORM.LearningAPI.Schema.InstructorAssignmentItem.ItemTypeName, key) {
        }
        ...
        public InstructorAssignmentItemIdentifier(LearningStoreItemIdentifier id) : 
            ...
            if ((id.ItemTypeName != DotNetSCORM.LearningAPI.Schema.InstructorAssignmentItem.ItemTypeName)) {
                throw new ArgumentOutOfRangeException("id");
            }
        }
    }
    ...
    /// <summary>
    /// Represents an identifier to a <Typ>/DotNetSCORM.LearningAPI.Schema.LearnerAssignmentItem</Typ> in a store.
    /// </summary>
    public class LearnerAssignmentItemIdentifier : LearningStoreItemIdentifier {
        ...
        public LearnerAssignmentItemIdentifier(long key) : 
                base(DotNetSCORM.LearningAPI.Schema.LearnerAssignmentItem.ItemTypeName, key) {
        }
        ...
        public LearnerAssignmentItemIdentifier(LearningStoreItemIdentifier id) : 
            ...
            if ((id.ItemTypeName != DotNetSCORM.LearningAPI.Schema.LearnerAssignmentItem.ItemTypeName)) {
                throw new ArgumentOutOfRangeException("id");
            }
        }
    }
